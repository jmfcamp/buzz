...
/** ~40% of avatar edge, floored at 10px — matches ~2× presence-dot scale. */
export function openClawWorkspaceBadgeSizeForAvatar(avatarPx: number): number {
  return Math.max(10, Math.round(avatarPx * 0.4));
}
